document.addEventListener('DOMContentLoaded', function() {
    // =================================================================================
    // ¡¡¡ATENCIÓN!!! PEGA AQUÍ TU CÓDIGO DE CONFIGURACIÓN DE FIREBASE
    // =================================================================================
    // Reemplaza todo el bloque de abajo con el código que copiaste de la web de Firebase.
    // Debe empezar con "const firebaseConfig = { ..."
    ...
    // Comprobación para asegurarse de que la configuración ha sido cambiada
    if (firebaseConfig.apiKey === "TU_API_KEY_AQUI" || firebaseConfig.projectId === "tu-proyecto") {
        alert("¡ATENCIÓN! Aún no has configurado la 'llave' de Firebase.\n\nPor favor, abre el archivo 'cuadrante.js' y reemplaza el bloque 'firebaseConfig' con tu código real de Firebase.");
        document.getElementById('login-container').innerHTML = "<h2>Error de Configuración</h2><p>Revisa el archivo cuadrante.js y pega tu configuración de Firebase.</p>";
